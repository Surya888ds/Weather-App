...
const WeatherApp = () => {
    ...
    let api_key = "8e5156c4000505c794bab89b20ea6979";
    ...
    return <div className="container">
        ...
        <div className="weather-location">Agartala</div>
        <div className="data-container">
            <div className="element">
                <img src={humidity_icon} alt="" className="icon" />
                <div className="data">
                    <div className="humidity-percent">32%</div>
            ...
            <div className="element">
                ...
                <div className="data">
                    <div className="wind-rate">10km/hr</div>
